...
var no = 0;
var noWords = 0;
var partialSearch = "<font class=\"highlightText\">Es gibt keine Seite, die alle Suchbegriffe beinhaltet.<br>Ergebnisse für:</font>";
var warningMsg = '<div style="padding: 5px;margin-right:5px;;background-color:#FFFF00;">';
warningMsg+='<b>Bitte beachten: Wegen Sicherheitseinstellungen markiert Google Chrome ';
warningMsg+=' die Suchergebnisse nicht richtig.</b><br>';
warningMsg+='Dies passiert nur, wenn die Dateien vom lokalen Speicher geladen werden.<br>';
warningMsg+='Lösungsvorschläge:';
warningMsg+='<ul>';
warningMsg+='<li>Verwende einen anderen Webbrowser.</li>';
warningMsg+='<li>Lade die Dateien der Seite direkt von einem Webserver.</li>';
warningMsg+='</div>';
txt_filesfound = 'Ergebnisse';
txt_enter_at_least_1_char = "Sie müssen mindestens einen Buchstaben eingeben.";
txt_enter_more_than_10_words = "Es wird nur nach den ersten 10 Wörtern gesucht.";
txt_browser_not_supported = "Ihr Browser wird nicht unterstützt. Es wird empfohlen, Mozilla Firefox zu verwenden.";
txt_please_wait = "Bitte warten. Suche wird durchgeführt...";
txt_results_for = "Ergebnisse für: ";

function SetCookie(searchForm) {
...
function GetCookie(searchForm) {
//alert($.cookie('textToSearch'));
/*searchTextField = trim(document.searchForm.textToSearch.value);
    searchTextField = searchTextField.replace(/['"]/g,'');
	var expressionInput = searchTextField;
...
function Effectuer_recherche(expressionInput) {
    ...
    var wordsList = new Array(); // Array with the words to look forsearchform
    var finalWordsList = new Array(); // Array with the words to look for after removing spaces
    var linkTab = new Array();
    var fileAndWordList = new Array();
    var txt_wordsnotfound = "Suchbegriff nicht gefunden.";
...
console.info("search : " + noWords.length + "   found : " + fileAndWordList[0][0].motslisteDisplay.split(",").length);
      ...
      for (var i = 0; i < cpt; i++) {
            ...
            if (fileAndWordList[i] != undefined) {
                linkTab.push('<p class="search_result">' + txt_results_for + " " + "<span class=\"searchExpression\">" + fileAndWordList[i][0].motslisteDisplay + "</span>" + "</p>");
                ...
                for (t in fileAndWordList[i]) {
                    ...
                    */
                    ...
                    var linkString = '<li><a id="' + idLink + '" href="' + tempPath + '" class="foundResult" target="_blank">' + tempTitle + '</a>';
...
//localeresource.search_no_results
        results = "<p>" + " <span class=\"searchExpression\">" + txt_wordsnotfound + "</span>" + "</p>";
    }
