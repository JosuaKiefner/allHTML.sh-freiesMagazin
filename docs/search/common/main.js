...
$(document).ready(function() {
	...
	if (document.getElementById('searchresult') && $.cookie('textToSearch') != undefined && $.cookie('textToSearch').length > 0) {
...
function searchHighlight(searchText) {
    ...
    if (searchText != undefined) {
        ...
        $("#content_idx").highlight(wList); //Highlight the search input
        ...
        $("#content_idx").highlight(sList); //Highlight the search input's all stems
    }
}
